...
/**
 * A manager for dealing with Singleton Components. Allows easy storage and retrieval of components that will always have only one instance
 * in the world. All the singleton components will be tied to a single entity. The entity will exist in the world and will be processed
 * by regular means.
 *
 * This manager allows to access the singleton components without having to specify them in EntitySystem's filter declaration.
 */
