package com.mightyquark.utils;

import com.badlogic.gdx.utils.Array;


/**
 * A non-throwing version of a libgx Array. I is used in many places internally to return a null instead of throwing an index out
 * of bounds exception.
 * 
 * The SafeArray was introduced after a transition from the original Bag implementation which behaved slightly differently
 * from a libgdx Array.
 * 
 * The hope is to eventually refactor the code such that it no longer has to rely on this implementation.
 */
