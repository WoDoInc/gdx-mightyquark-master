package com.mightyquark.systems.event;

import com.mightyquark.systems.EntitySystem;
import com.badlogic.gdx.utils.Array;
import com.badlogic.gdx.utils.ObjectMap;
import com.badlogic.gdx.utils.ObjectMap.Entry;

/**
 * Basic implementation of event system. All the events that are sent in gets put into a buffer. During the processing cycle, the
 * buffered events get transfered to the currentEvents list where they can be consumed when interested parties call getEvents.
 * CurrentEvents gets cleared during every processing cycle.
 *
 * If there are systems that need events to last longer than a single processing cycle, use a different EventSystem such as
 * DedicatedQueueEventSystem.
 */
